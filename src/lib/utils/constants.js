...
export const REFLECTION_CONTENT = {
	...
	paragraphs: [
		...
		'Het belangrijkste wat ik heb geleerd is dat je in IT altijd open moet blijven voor nieuwe dingen. De seminaries gaven me veel nieuwe kennis maar de hackathons leerden me iets anders. Hackathons zijn over snel leren, samenwerken onder druk en iets afmaken wat werkt.',
		...
		'Naast deze activiteiten heb ik ook aan persoonlijke ontwikkeling gewerkt. De POP-sessies over veerkracht en teamdynamiek hebben me geholpen om mezelf beter te kennen. De projectweek over kernkwadranten en netwerken gaf me inzicht in mijn waarden en hoe ik beter kan communiceren. Deze persoonlijke ontwikkelingen vormden de basis voor hoe ik in teams kan functioneren en hoe ik kan groeien als persoon.',
		'Mijn sterke punten zijn teamwork en doorzettingsvermogen. Ik geef niet snel op. In de hackathons merkte ik dit goed. Bij Hack the Future hadden we veel time pressure en moesten we snel een werkende app afmaken. We hebben het toch afgekregen ondanks de korte tijdspan. Ik kan goed met verschillende soorten mensen samenwerken en dat heb ik echt geoefend in het BIP met marketing en management studenten en in de hackathons met developers.',
